...
<span style="font-size:1.3rem;">⚠️</span> <strong style="color:#DC2626;">Phát hiện quan trọng:</strong>
...
gấp <strong>{ratio:.1f}x</strong> so với nhóm năng suất Cao (<strong>{q_high:.1f}%</strong>).
            ...
            st.plotly_chart(fig_quit, use_container_width=True)
