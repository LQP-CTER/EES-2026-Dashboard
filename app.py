...
def _render_login_page():
    ...
    <div class='login-wrap'>
        <div class='login-card'>
            <img class='login-logo' src='https://res.cloudinary.com/dd7gti2kn/image/upload/v1772778208/LOGO%20GHN/LOGO_INAN_1_lghbnf.png' alt='GHN Logo'>
            <div class='login-title'>Đăng nhập EES 2026</div>
            <div class='login-subtitle'>Dùng tài khoản Google nội bộ để truy cập dashboard. Hệ thống chỉ cho phép email thuộc domain công ty.</div>
    """, unsafe_allow_html=True)
    ...
    with st.form("login_form", clear_on_submit=False):
        st.markdown("<span class='login-field-label'>Nhập email nội bộ</span>", unsafe_allow_html=True)
    ...
    st.markdown("<div class='login-note'>Nếu Google báo 403 trên Streamlit Cloud, nguyên nhân thường là `redirect_uri` trong Google Cloud Console chưa khớp chính xác với URL deploy.</div>", unsafe_allow_html=True)
